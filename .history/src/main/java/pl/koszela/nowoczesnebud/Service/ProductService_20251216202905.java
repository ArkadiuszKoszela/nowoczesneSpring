...
public class ProductService {
    ...
    public void deleteMultipleGroupsWithProgress(
        ...
        if (allProducts.size() > 0) {
            ...
            // Wyślij statusy postępu podczas usuwania (co 10% produktów)
            int progressInterval = Math.max(1, allProductIds.size() / 10); // Co 10%
            int lastProgressSent = 0;
            
            // Usuń wszystkie produkty w jednym batchu
