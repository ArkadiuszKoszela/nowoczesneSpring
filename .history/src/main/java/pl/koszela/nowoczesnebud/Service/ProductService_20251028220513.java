...
public class ProductService {
     ...
     * POPRAWIONA LOGIKA - oblicza także ceny sprzedaży!
     */
    @Transactional
        ...
        for (Product product : products) {
            for (Input input : inputList) {
                if (product.getMapperName() != null && 
                    ...
                    // 2. Przelicz cenę zakupu jeśli potrzeba
                    ...
                    // 3. Oblicz cenę sprzedaży (jeśli nie jest ustawiona)
                    // Używamy ceny detalicznej jako domyślnej ceny sprzedaży
                    if (product.getSellingPrice() == 0.00 && product.getRetailPrice() != 0.00) {
