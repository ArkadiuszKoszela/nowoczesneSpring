...
public class ProjectService {
    ...
    public void saveDraftChanges(Long projectId, SaveDraftChangesRequest request) {
        ...
        // 2. BATCH INSERT - użyj saveAll() zamiast persist() w pętli
        // Problem: persist() w pętli jest bardzo wolne (~31ms na rekord) bo Hibernate sprawdza duplikaty w kontekście
        // Rozwiązanie: Przygotuj wszystkie encje, a potem użyj saveAll() w batchach - Hibernate zoptymalizuje to do batch INSERT-ów
        ...
        // Przygotuj wszystkie encje w batchach
        ...
        for (int batchIndex = 0; batchIndex < totalBatches; batchIndex++) {
            ...
            List<ProjectDraftChange> batchDrafts = new ArrayList<>(recordsInBatch);
            ...
            // Zapisz batch używając saveAll() - Hibernate zoptymalizuje to do batch INSERT-ów
            long batchSaveStart = System.currentTimeMillis();
            projectDraftChangeRepository.saveAll(batchDrafts);
            long batchSaveEnd = System.currentTimeMillis();
            long batchSaveTime = batchSaveEnd - batchSaveStart;
            
            logger.info("⏱️ [PERFORMANCE] Batch {}/{} zapisany | rekordów: {} | czas zapisu: {}ms", 
                       batchIndex + 1, totalBatches, recordsInBatch, batchSaveTime);
        }
        
        long prepareEndTime = System.currentTimeMillis();
        long prepareTime = prepareEndTime - prepareStartTime;
