            ...
            public void execute(Connection connection) throws SQLException {
                try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
                    for (int batchIndex = 0; batchIndex < totalBatches; batchIndex++) {
                        ...
                        // - ujemne wartości dla błędów (Statement.SUCCESS_NO_INFO = -2)
                        int insertCount = 0;
                        int updateCount = 0;
                        int errorCount = 0;
                        ...
                        logger.info("⏱️ [PERFORMANCE] Batch {}/{} przetworzony (UPSERT draft_is_main_option) | rekordów: {} | INSERT: {} | UPDATE: {} | ERROR: {} | czas: {}ms", 
                                   batchIndex + 1, totalBatches, recordsInBatch, insertCount, updateCount, errorCount, batchUpdateTime);
