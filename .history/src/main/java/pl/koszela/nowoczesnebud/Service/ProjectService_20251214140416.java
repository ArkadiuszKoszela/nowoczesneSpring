...
public class ProjectService {
    ...
    public void saveDraftChanges(Long projectId, SaveDraftChangesRequest request) {
        ...
        for (int i = 0; i < totalChanges; i++) {
            ...
            persistTime += (persistEnd - persistStart);
            
            // Loguj co 100 rekordów, aby zobaczyć postęp
            if ((i + 1) % 100 == 0) {
                long currentTime = System.currentTimeMillis();
                long timeSinceLastBatch = currentTime - lastBatchEndTime;
                logger.info("⏱️ [PERFORMANCE] Postęp: {}/{} rekordów | czas od ostatniego batcha: {}ms | prepare: {}ms | persist: {}ms", 
                           i + 1, totalChanges, timeSinceLastBatch, prepareTime, persistTime);
            }
