...
public class ProjectService {
    ...
    public void saveDraftChanges(Long projectId, SaveDraftChangesRequest request) {
        ...
        int batchSize = 1000; // Batch size dla JDBC
        int totalBatches = (int)Math.ceil((double)totalChanges / batchSize);
        
        // Pobierz połączenie JDBC z EntityManager
        ...
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            for (int batchIndex = 0; batchIndex < totalBatches; batchIndex++) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    // Konwertuj GroupOption na String
                    String draftIsMainOption = dto.getDraftIsMainOption() != null ? dto.getDraftIsMainOption().toString() : null;
