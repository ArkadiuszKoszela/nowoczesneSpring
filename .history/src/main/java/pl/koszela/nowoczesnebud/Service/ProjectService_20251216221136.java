            ...
            public void execute(Connection connection) throws SQLException {
                try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
                    for (int batchIndex = 0; batchIndex < totalBatches; batchIndex++) {
                        ...
                        logger.info("⏱️ [PERFORMANCE] Batch {}/{} przetworzony (UPDATE draft_is_main_option) | rekordów: {} | UPDATE: {} | NO-OP: {} | ERROR: {} | czas: {}ms", 
                                   batchIndex + 1, totalBatches, recordsInBatch, updateCount, noOpCount, errorCount, batchUpdateTime);
