...
public class ProductService {
    ...
    public void deleteMultipleGroupsWithProgress(
        ...
        // Grupuj produkty według grupy (manufacturer + groupName) dla lepszego progress tracking
        ...
        // Usuń produkty grupa po grupie (dla lepszego progress tracking), ale używając JDBC batch DELETE
        for (Map<String, String> group : groups) {
            ...
            if (!groupProducts.isEmpty()) {
                // Wyślij status przed usunięciem grupy
                ...
                // Usuń produkty tej grupy używając JDBC batch DELETE
                List<Long> productIds = groupProducts.stream().map(Product::getId).collect(Collectors.toList());
                batchDeleteProductsByIds(productIds);
                
                totalDeletedProducts += groupProducts.size();
                processedGroups++;
                
                // Wyślij status po usunięciu grupy
