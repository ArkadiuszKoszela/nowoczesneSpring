    ...
    public void createOffer(Offer offer) {
        ...
        try {
            ...
            if (tiles.isEmpty() && gutters.isEmpty() && accessories.isEmpty()) {
                ...
                System.err.println("   1. Produkty mają isMainOption = true");
                System.err.println("   2. Produkty mają ilość > 0");
                System.err.println("   3. Użytkownik kliknął 'Przelicz produkty' w zakładce 'Wprowadź dane'");
                throw new IllegalStateException("Brak produktów do wygenerowania PDF. Wybierz produkty jako 'Główna' (zielony badge) i upewnij się że mają ilość > 0.");
            }
