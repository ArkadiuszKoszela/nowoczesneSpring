...
-- Krok 4: Zmień nazwę kolumny tymczasowej (H2 używa ALTER TABLE ... ALTER COLUMN ... RENAME TO)
ALTER TABLE project_product_groups 
  ALTER COLUMN is_main_option_temp RENAME TO is_main_option;

-- Krok 5: Ustaw wartości NULL na 'NONE' (na wypadek gdyby coś zostało)
UPDATE project_product_groups 
...
-- Krok 4: Zmień nazwę kolumny tymczasowej
ALTER TABLE project_draft_changes_ws 
  ALTER COLUMN draft_is_main_option_temp RENAME TO draft_is_main_option;
