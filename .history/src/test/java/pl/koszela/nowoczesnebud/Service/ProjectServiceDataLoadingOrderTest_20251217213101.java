...
public class ProjectServiceDataLoadingOrderTest extends BaseProjectServiceTest {
    ...
    public void testUltraHardcore_ChaosScenario() {
        ...
        // Utwórz nowy projekt dla tego testu (z nowym użytkownikiem - unique constraint na client_id)
        User testUser2 = new User();
        testUser2.setName("Test");
        testUser2.setSurname("User 2");
        Address address2 = new Address();
        address2.setAddress("Test Address 2");
        address2.setLatitude(52.0);
        address2.setLongitude(21.0);
        address2.setZoom(10.0);
        testUser2.setAddress(address2);
        testUser2 = userRepository.save(testUser2);
        entityManager.flush();
        
        Project testProject2 = new Project();
        testProject2.setClient(testUser2);
        ...
        // Kolejność B: najpierw opcja grupy, potem draft changes (z nowym użytkownikiem)
        User testUser3 = new User();
        testUser3.setName("Test");
        testUser3.setSurname("User 3");
        Address address3 = new Address();
        address3.setAddress("Test Address 3");
        address3.setLatitude(52.0);
        address3.setLongitude(21.0);
        address3.setZoom(10.0);
        testUser3.setAddress(address3);
        testUser3 = userRepository.save(testUser3);
        entityManager.flush();
        
        Project testProject3 = new Project();
        testProject3.setClient(testUser3);
        testProject3 = projectRepository.save(testProject3);
        entityManager.flush();
        ...
        for (Product product : products.subList(0, 2)) {
            ...
            dto.setDraftQuantity(5.0);
            dto.setDraftMarginPercent(10.0);
            // ⚠️ WAŻNE: Musimy zachować opcję grupy z updateGroupOptionBatch
            if (product.getId().equals(products.get(0).getId())) {
                dto.setDraftIsMainOption(GroupOption.MAIN);
            }
    ...
    public void testUltraEdgeCases_UnlikelyScenarios() {
        ...
        // Utwórz nowy projekt z nowym użytkownikiem (unique constraint na client_id)
        User testUser4 = new User();
        testUser4.setName("Test");
        testUser4.setSurname("User 4");
        Address address4 = new Address();
        address4.setAddress("Test Address 4");
        address4.setLatitude(52.0);
        address4.setLongitude(21.0);
        address4.setZoom(10.0);
        testUser4.setAddress(address4);
        testUser4 = userRepository.save(testUser4);
        entityManager.flush();
        
        Project testProject4 = new Project();
        testProject4.setClient(testUser4);
        testProject4 = projectRepository.save(testProject4);
        entityManager.flush();
        ...
        // ⚠️ WAŻNE: Musimy zachować opcję grupy z updateGroupOptionBatch (MAIN)
        cycle1Dto.setDraftIsMainOption(GroupOption.MAIN);
        ...
        // ⚠️ WAŻNE: Musimy zachować opcję grupy z updateGroupOptionBatch (OPTIONAL)
        cycle2Dto.setDraftIsMainOption(GroupOption.OPTIONAL);
        ...
        testUser5.setName("Test");
        testUser5.setSurname("User 5");
        Address address5 = new Address();
        address5.setAddress("Test Address 5");
        address5.setLatitude(52.0);
        address5.setLongitude(21.0);
        address5.setZoom(10.0);
        testUser5.setAddress(address5);
        testUser5 = userRepository.save(testUser5);
        entityManager.flush();
        
        Project testProject5 = new Project();
        testProject5.setClient(testUser5);
        testProject5 = projectRepository.save(testProject5);
        entityManager.flush();
