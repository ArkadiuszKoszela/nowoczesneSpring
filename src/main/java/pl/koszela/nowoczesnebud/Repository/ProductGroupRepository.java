...
public interface ProductGroupRepository extends JpaRepository<ProductGroup, Long> {
    ...
    List<ProductGroup> findProductGroupIsOptionIsMain ();

    @Query(value = "SELECT * from product_group where option_name = 0", nativeQuery = true)
    List<ProductGroup> findProductGroupIsOptionIsOption ();
