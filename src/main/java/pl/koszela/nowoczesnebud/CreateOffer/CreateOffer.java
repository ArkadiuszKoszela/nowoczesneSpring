...
public class CreateOffer {
    ...
    public void createOffer(Project project) {
        ...
        try {
            ...
            // ========== Pobierz produkty ze snapshotów projektu ==========
            // ⚠️ WAŻNE: Input są teraz tylko z formularza (mapperName, quantity)
            // Produkty są w snapshotach - musimy je pobrać i dopasować do Input
     ...
     */
    /**
     * Pobiera produkty ze snapshotów projektu i dopasowuje do Input z formularza
     */
    ...
    private void addElegantProductSection(Document document, String sectionTitle, List<Product> products) 
        ...
        for (Product product : products) {
            ...
            // Jednostka - z produktu lub domyślnie "szt"
     ...
     * ZAKTUALIZOWANE: Używa Product ze snapshotów
     */
